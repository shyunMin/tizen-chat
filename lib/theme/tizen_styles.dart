...
class TizenStyles {
  ...
  static const double colMax = 450.0; // 850px ÷ 2.0 (design_03: 640→700px)
  ...
  static const double focusGlowSpreadRadius =
      1.8; // .12cqw=2.3px÷2≈1.15 → visual match
  ...
  static const TextStyle sentText = TextStyle(color: txt2, fontSize: tAskSaid);
